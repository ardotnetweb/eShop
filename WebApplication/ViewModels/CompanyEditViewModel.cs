...
namespace WebApplication.ViewModels
{
    public class CompanyEditViewModel
    {
        ...
        [Remote("CheckNameEdit", "Company", ErrorMessage = "این نام قبلا در پایگاه داده ثبت شده است", AdditionalFields = "Id")]
        ...
        [Remote("CheckAddressEdit", "Company", ErrorMessage = "این آدرس قبلا در پایگاه داده ثبت شده است", AdditionalFields = "Id")]
