...
namespace WebApplicationCapchaImagePersian.Models
{
    ...
    public class CaptchaImageResult : ActionResult
    {
        ...
        /// </summary>
        //private readonly Color _backGroundColor = System.Drawing.ColorTranslator.FromHtml("#f8f8f8");
        private readonly Color _backGroundColor = Color.FromArgb(255, 255, 255);
        ...
        /// </summary>
        private const string EncryptionKey = "^%$#@ARZEramWeb_!#$%^&*";
        ...
        public override void ExecuteResult(ControllerContext context)
        {
            ...
            Font font = new Font(CaptchaFontFamily, CaptchaFontSize,FontStyle.Regular);
            ...
            //    u = xx - r;
            //    v = yy - r;
            //    gfxCaptchaImage.DrawLines(pen, u, v, r, r);
            //}

            //for (int i = 0; i < 10; i++)
            //{
            //    pen.Color = Color.FromArgb(255, 255, 255);
            //    gfxCaptchaImage.DrawLines(pen, new Point[] { new Point(i), new Point(i + 10), new Point(i + 20) });
            //}
