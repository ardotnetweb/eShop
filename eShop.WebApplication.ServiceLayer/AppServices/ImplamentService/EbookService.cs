...
{
    public class EbookService : EntityService<eBook>, IEbookService
    {
        private readonly IDbSet<eBook> _dbSet;
        private IUnitOfWork _unitOfWork;
        public EbookService(IUnitOfWork _unitOfWork)
            : base(_unitOfWork)
        {      
            this._unitOfWork = _unitOfWork;
            this._dbSet=_unitOfWork.Set<eBook>();
        }
    }
}
